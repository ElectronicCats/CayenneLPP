/*
 ...
 Hardware:
 - Shield Weather Station SparkFun
 - Shield LoRa ElectronicCats
 - Arduino MEGA
 */
...
static const u1_t PROGMEM APPKEY[16] = {0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x42,0x14,0x82};
